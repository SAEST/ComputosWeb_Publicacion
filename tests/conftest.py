...
def setup():
    ...
    url = 'https://computos2024.ine.mx/presidencia/nacional/candidatura'
    driver.get(url)
...
def pytest_html_report_title(report):  
    report.title = "Reporte Pruebas de Publicación Cómputos Distritales"  
  
def pytest_configure(config):  
    config.stash[metadata_key]["Project"] = "Pruebas Sitio Publicación Cómputos Distritales y CSV"  