pipeline {
    agent any    
    environment {
        VENV_DIR = '/var/jenkins_home/workspace/ComputosWeb_Publicacion/venv'
    ...
    stages {
        stage('Clean Up and Checkout ') {
            steps {
                ...
                git url: 'https://github.com/SAEST/ComputosWeb_Publicacion.git', branch: 'main'
            }
        }
        ...
        stage('Ejecutar Test con Pytest, Selenium - POM') {
            steps {
                ...
                sh """
                    ...
                    pytest_html_merger -i /var/jenkins_home/workspace/ComputosWeb_Publicacion/reports/pytestreport -o /var/jenkins_home/workspace/ComputosWeb_Publicacion/reports/pytestreport/report.html
               """
                }
            }
        }
